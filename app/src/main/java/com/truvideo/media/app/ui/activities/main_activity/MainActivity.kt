...
class MainActivity : ComponentActivity() {
    ...
    fun Content() {
        ...
        val filePickerLauncher = rememberLauncherForActivityResult(TruvideoSdkFilePickerContract()) { path ->
            ...
            builder.deleteOnComplete(false)
        ...
        Content(
            requests = requests,
            onPickFilePressed = { filePickerLauncher.launch(TruvideoSdkFilePickerType.VideoAndPicture) }
        )
    }
