...
internal class TruvideoSdkMediaFileUploadEngine(
    ...
    suspend fun upload(id: String, callback: TruvideoSdkMediaFileUploadCallback) {
        ...
        if (credentials == null) {
            ...
            throw TruvideoSdkMediaException("Invalid credentials")
        }
        ...
        if (entity == null) {
            ...
            throw TruvideoSdkMediaException("File upload request not found")
        }
        ...
        try {
                        ...
                        scope.launch {
                            mutex.withLock {
                                if (state == TruvideoSdkMediaFileUploadStatus.ERROR) {
                                    ...
                                    callback.onError(id, TruvideoSdkMediaException(errorMessage))
                                }
                            }
                        }
                    }
            ...
            throw TruvideoSdkMediaException(message)
        }
    }
